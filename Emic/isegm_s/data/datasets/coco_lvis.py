...
class CocoLvisDataset(ISDataset):
    ...
    def get_sample(self, index) -> DSample:
        image_id, sample = self.dataset_samples[index] #ex index=0 ,000000000030 ; {'num_instance_masks': 3, 'hierarchy': {0: {'children': [1], 'parent': None, 'node_level': 0}, 1: {'children': [], 'parent': 0, 'node_level': 1}, 2: None}}
        ...
        with open(packed_masks_path, 'rb') as f:
            encoded_layers, objs_mapping = pickle.load(f)  # 一張圖有多個mask [(0, 3), (1, 1), (2, 1), (0, 1), (0, 4), (0, 2)], (第幾張,那張中的第幾類)
