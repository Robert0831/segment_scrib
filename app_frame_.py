...
def choose_fold():
    ...
    widge=QtWidgets.QTableWidget()
    widge.setFixedHeight(300)
    widge.setFixedHeight(400)
    table_widget = QtWidgets.QTableWidget(widge)
    table_widget.setGeometry(50, 50, 400, 200)
    table_widget.setFixedHeight(300)
    table_widget.setFixedHeight(400)
    fname=QFileDialog.getExistingDirectory(widge, "Open Folder", "")
